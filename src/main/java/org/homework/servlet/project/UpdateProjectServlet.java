...
public class UpdateProjectServlet extends HttpServlet {
    ...
    private final CrudView<Project, Long> updateDoGet = new CrudViewImpl<>(Project.class);
    private static UpdateProjectServlet updateProjectServlet;

    public static UpdateProjectServlet getInstance() {
        if (updateProjectServlet == null) {
            updateProjectServlet = new UpdateProjectServlet();
        }
        return updateProjectServlet;
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (!Validator.validName(name)) {
            ...
            service.update(new Project(Long.valueOf(req.getParameter("id")), name, Long.valueOf(cost),new Date().toString(), Long.valueOf(companyId), Long.valueOf(customerId)));
